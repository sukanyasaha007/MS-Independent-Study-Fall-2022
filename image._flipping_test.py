...
model= keras.models.load_model(r"C:\Users\sahasuka\OneDrive - Intel Corporation\Desktop\Personal\Self-driving car\MS-Independent-Study-Fall-2022\model\model.h5")
